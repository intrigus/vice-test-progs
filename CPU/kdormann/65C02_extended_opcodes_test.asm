...
;masking of always on bits after PHP or BRK (unused & break) on compare
        !if I_flag = 0 {
!macro load_flag arg1  {
            lda #arg1&m8i         ;force enable interrupts (mask I)
            }
!macro cmp_flag arg1   {
            cmp #(arg1|fao)&m8i   ;I_flag is always enabled + always on bits
            }
!macro eor_flag arg1   {
            eor #(arg1&m8i|fao)   ;mask I, invert expected flags + always on bits
            }
        }
        !if I_flag = 1 {
!macro load_flag arg1  {
            lda #arg1|intdis      ;force disable interrupts
            }
!macro cmp_flag arg1   {
            cmp #(arg1|fai)&m8    ;I_flag is always disabled + always on bits
            }
!macro eor_flag arg1   {
            eor #(arg1|fai)       ;invert expected flags + always on bits + I
            }
        }
        !if I_flag = 2 {
!macro load_flag arg1  {
...
!macro cmp_flag  arg1  {
            ...
            cmp #(arg1|fao)&m8i   ;expected flags + always on bits, mask I
            }
!macro eor_flag arg1   {
            eor flag_I_on       ;I_flag is never changed
            eor #(arg1&m8i|fao)   ;mask I, invert expected flags + always on bits
        ...
        !if I_flag = 3 {
!macro load_flag arg1  {
            lda #arg1             ;allow test to change I-flag (no mask)
            }
!macro cmp_flag arg1   {
            cmp #(arg1|fao)&m8    ;expected flags + always on bits
            }
!macro eor_flag arg1   {
            eor #arg1|fao         ;invert expected flags + always on bits
            }
        }
...
!macro set_a arg1,arg2      {        ;precharging accu & status
            +load_flag arg2
            pha         ;use stack to load status
            lda #arg1     ;precharge accu
            plp
            }

!macro set_x arg1,arg2      {        ;precharging index & status
            +load_flag arg2
            pha         ;use stack to load status
            ldx #arg1    ;precharge index x
            plp
            }

!macro set_y arg1,arg2      {        ;precharging index & status
            +load_flag arg2
            pha         ;use stack to load status
            ldy #arg1     ;precharge index y
            plp
            }

!macro set_ax arg1,arg2     {        ;precharging indexed accu & immediate status
            +load_flag arg2
            pha         ;use stack to load status
            lda arg1,x    ;precharge accu
            plp
            }

!macro set_ay arg1,arg2     {        ;precharging indexed accu & immediate status
            +load_flag arg2
            pha         ;use stack to load status
            lda arg1,y    ;precharge accu
            plp
            }

!macro set_z  arg1,arg2     {        ;precharging indexed zp & immediate status
            +load_flag arg2
            pha         ;use stack to load status
            lda arg1,x    ;load to zeropage
            sta zpt
            plp
            }

!macro set_zx      {        ;precharging zp,x & immediate status
            +load_flag arg2
            pha         ;use stack to load status
            lda arg1,x    ;load to indexed zeropage
            sta zpt,x
            plp
            }

!macro set_abs  arg1,arg2   {        ;precharging indexed memory & immediate status
            +load_flag arg2
            pha         ;use stack to load status
            lda arg1,x    ;load to memory
            sta abst
            plp
            }

!macro set_absx arg1,arg2   {        ;precharging abs,x & immediate status
            +load_flag arg2
            pha         ;use stack to load status
            lda arg1,x    ;load to indexed memory
            sta abst,x
            plp
            }

;macros to test (register|memory|zeropage) & status & (mask)
!macro tst_stat arg1   {        ;testing flags in the processor status register
            php         ;save status
...
!macro tst_a   arg1,arg2    {        ;testing result in accu & flags
            php         ;save flags
            php
            cmp #arg1     ;test result
            +trap_ne
            pla         ;load status
            +cmp_flag arg2
            +trap_ne
...
!macro tst_as  arg1,arg2    {        ;testing result in accu & flags, save accu
            pha
            php         ;save flags
            php
            cmp #arg1     ;test result
...
!macro tst_x   arg1,arg2    {        ;testing result in x index & flags
            php         ;save flags
            php
            cpx #arg1     ;test result
            +trap_ne
            pla         ;load status
            +cmp_flag arg2
            +trap_ne
...
!macro tst_y  arg1,arg2     {        ;testing result in y index & flags
            php         ;save flags
            php
            cpy #arg1     ;test result
            +trap_ne
            pla         ;load status
            +cmp_flag arg2
            +trap_ne
...
!macro tst_ax  arg1,arg2,arg3    {        ;indexed testing result in accu & flags
            php         ;save flags
            cmp arg1,x    ;test result
            +trap_ne
            pla         ;load status
            +eor_flag arg3
            cmp arg2,x    ;test flags
            +trap_ne     ;
            }

!macro tst_ay  arg1,arg2,arg3    {        ;indexed testing result in accu & flags
            php         ;save flags
            cmp arg1,y    ;test result
            +trap_ne     ;
            pla         ;load status
            +eor_flag arg3
            cmp arg2,y    ;test flags
            +trap_ne
            }
        
!macro tst_z  arg1,arg2,arg3     {        ;indexed testing result in zp & flags
            php         ;save flags
            lda zpt
            cmp arg1,x    ;test result
            +trap_ne
...
!macro tst_zx  arg1,arg2,arg3    {        ;testing result in zp,x & flags
            php         ;save flags
            lda zpt,x
            cmp arg1,x    ;test result
            +trap_ne
...
!macro tst_abs  arg1,arg2,arg3   {        ;indexed testing result in memory & flags
            php         ;save flags
            lda abst
            cmp arg1,x    ;test result
            +trap_ne
...
!macro tst_absx  arg1,arg2,arg3  {        ;testing result in abs,x & flags
            php         ;save flags
            lda abst,x
            cmp arg1,x    ;test result
            +trap_ne
...
ccs2\?      inx
            bne ccs3\?
            ldx #>(data_segment) ;set high byte of indirect pointer
            stx zpt+1
            ldy #<(data_bss) ;data after write test area
ccs5\?      adc (zpt),y
            bcc ccs4\?
            inc zpt+3       ;carry to high byte
            clc
...
!macro bbt  arg1   {            ;\1 = bitnum
        lda #(1<<arg1)    ;testing 1 bit on
        sta zpt
...
ok2\?   
        ...
        cmp #(1<<arg1)
        +trap_ne         ;zp altered
        lda #$ff-(1<<arg1) ;testing 1 bit off
        sta zpt
        +set_a $33,0     ;with flags off
        +bbs arg1,zpt,fail3\?
        +bbr arg1,zpt,ok3\?
...
!macro nop_test arg1,arg2   {        ;\1 = opcode, \2 = # of bytes
            ldy #$42
            ldx #4-arg2
            !byte  arg1          ;test nop length
        !if arg2 = 1 {
            dex
            dex
        }
        ...
        !if arg2 = 3 {
            ...
            +set_a $ff-arg1,0
            !byte  arg1          ;test nop integrity - flags off
            nop
            nop
            +tst_a $ff-arg1,0
            +set_a $aa-arg1,$ff
            !byte  arg1          ;test nop integrity - flags on
            nop
            nop
            +tst_a $aa-arg1,$ff
            cpy #$42
...
ji_ret  php             ;either SP or Y count will fail, if we do not hit
        ...
        +trap_cc
        +trap_vc
        cmp #('I' xor $aa)  ;returned registers OK?
        +trap_ne
        cpx #('N'+1)
        +trap_ne
        cpy #('D'-6)
...
!macro trbt  arg1,arg2  {        ;\1 = memory, \2 = flags
        sty arg1
        +load_flag arg2
        pha
        lda zpt+1
...
!macro tsbt  arg1,arg2  {        ;\1 = memory, \2 = flags
        sty arg1
        +load_flag arg2
        pha
        lda zpt+1
...
; decimal ADC / SBC (zp,x)
        php             ;save carry for subtract
        lda ad1
        adc (< adi2-ad2,x) ;perform add         FIXME
        php          
        cmp adrl        ;check result
        +trap_ne         ;bad result
        pla             ;check flags
        ...
        php             ;save carry for next add
        lda ad1
        sbc (< sbi2-ad2,x) ;perform subtract    FIXME
        php          
        cmp adrl        ;check result
        +trap_ne         ;bad result
        pla             ;check flags
