 ...
 2801 x1=int(ra(0,0)/fq*100+0.5)/100
 2802 x2=int(ra(0,1)/fq*100+0.5)/100
 2803 x3=int(ra(1,0)/fq*100+0.5)/100
 2804 x4=int(ra(1,1)/fq*100+0.5)/100
 2840 print" x  "x1"{left}us{left}{left}",
 2850 print"{rght}{rght}{rght}"x2"{left}us{left}",
 2860 print"  "x3"{left}us",
 2870 print" "x4"{left}us":print"     ";:poke53280,5
 2871 x=x1:mi=2.75:ma=3.00:gosub4000
 2872 x=x2:mi=2.72:ma=2.94:gosub4000
 2873 x=x3:mi=2.77:ma=3.01:gosub4000
 2874 x=x4:mi=2.74:ma=2.98:gosub4000
 2880 print:print" a= 1541-2        1. of 1 device
 ...
 2970 print"{down}{down}{up} <Return>";
 2975 gosub 5000
 2980 input a$
 ...
 4000 if x < mi then print "<min     ";:poke53280,10:return
 4001 if x > ma then print ">max     ";:poke53280,10:return
 4002 print"ok       ";:return
 
 5000 if peek(53280) and 15 = 10 then poke 55295,255
 5001 if peek(53280) and 15 <> 10 then poke 55295,0
 5010 return 
